...
import afiliate from '../../assets/become-affiliate.png'
const Affiliate = () => {
    ...
    return (
      <div className='h-full w-full'>
        ...
        <div className='shadow-md bg-white rounded-xl p-6 mb-8'>
          <h1 className='text-2xl font-semibold tracking-wider'>Affiliate Request</h1>
          <p className='text-sm text-gray-600 mt-1'>
           All your affiliate data like affiliate links, affiliate commissions, payout data are displayed here, once your affiliate request is approved.
          </p>
        </div>
        ...
        <div className='relative shadow-md bg-white rounded-xl p-10 mt-8'>
          ...
          <h1 className='text-xl font-medium mb-6'>Affiliate Request (Approval/Disapproval)</h1>
          <div className='flex md:flex-row flex-col gap-12'>
            <img src={afiliate} alt="subs" className='w-80 h-40' />
  
            <div className='bg-white p-6 rounded-xl shadow-md'>
              <h2 className='text-xl  mb-2'>Affiliate Request (Approval/Disapproval)</h2>
